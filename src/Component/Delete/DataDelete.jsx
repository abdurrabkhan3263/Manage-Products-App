...
function DataDelete({ deleteData, setDeleteData, QueryKey }) {
  ...
  return (
    <div
      ...
      } border-1 absolute bottom-1/2 right-[55%] z-50 flex h-[45%] w-1/4 translate-x-[55%] translate-y-1/2 items-center justify-center gap-y-5`}
    >
      <div className={`card`}>
        <div className="card-content">
          <p className="card-heading">Delete file?</p>
          <p className="card-description">Do You Really Want To Delete It ?</p>
        </div>
        <div className="card-button-wrapper">
          ...
          <button className="card-button primary" onClick={handleProductDelete}>
            Delete
          </button>
        </div>
        <button
